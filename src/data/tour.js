export default {
  scenes: [
    ...
    //       text:
    //         'The Oriente Station is one of the most important bus and train stations in the city. Designed by the Spanish architect and engineer Santiago Calatrava, it has an enormous metal skeleton that covers the eight train lines and its platforms. Finished in 1998 to serve the Expo’98 and, later, the Parque das Nações area, in its surroundings are companies, services, hotels, bars, animation, as well as the well known Vasco da Gama shopping centre.',
    //     },
    //   ],
    // },
    // {
    ...
    },
    {
      ...
      faceSize: 1576,
      initialViewParameters: {
        yaw: -0.20709883579638344,
        pitch: 0.16339732398486007,
      ...
      infoHotspots: [
        {
          yaw: -0.9369940656871805,
          pitch: 0.06781473774649527,
          title: 'Vino',
          text: 'Grasevina neka',
        },
      ],
